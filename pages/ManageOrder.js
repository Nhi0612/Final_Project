                                ...
                                <h2 className="text-uppercase"  style = {{marginBottom: '20px'}}>Manage Order</h2>
                                        ...
                                        style={{minWidth: '600px', cursor: 'pointer'}}>
                                            <thead  style = {{backgroundColor : "#2f3640", color: '#fff'}}>
                                                <tr>
                                                    <td  className= "p-2" scope="col">Gmail</td>
                                                    <td  className= "p-2" scope="col">Name</td>
                                                    <td  className= "p-2" scope="col">Date</td>
                                                    <td  className= "p-2" scope="col">Amount</td>
                                                ...
                                                
                                                {
                                                    orders.map(order => (
                                                        <tr key={order._id}>
                                                            ...
                                                            <td key={order._id} scope="row" className= "p-2">
                                                                    <Link href={`/order/${order._id}`}>
                                                                        <a>{order.user.email}</a>
                                                                    </Link>
                                                            </td>

                                                            <td scope="row" className= "p-2">{order.user.name}</td>
                                                        
                                                            <td scope="row" className= "p-2">
                                                                {new Date(order.createdAt).toLocaleDateString()}
                                                            </td>
                                                            <td scope="row" className= "p-2 text-center">{order.cart.length}</td>
