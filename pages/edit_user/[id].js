...
const EditUser = () => {
    ...
    return (
        <div>
            <NavBar></NavBar>
            <div className="edit_user my-3 small-container" style = {{ height: "30rem"}}>
                <Head>
                ...
                <div className="col-md-4 mx-auto my-4">
                    ...
                    <div className="form-group " >
                        ...
                        <input type="text" id="name" className= "form-control" defaultValue={editUser.name} disabled />
                    </div>

                    <div className="form-group">
                        <label htmlFor="email" className="d-block">Email</label>
                        <input type="text" id="email" className= "form-control" defaultValue={editUser.email} disabled />
                    </div>
